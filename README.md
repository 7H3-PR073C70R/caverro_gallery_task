...
A Canverro Gallery Task Project created by Very Good CLI.
...
_\*Canverro Gallery Task works on iOS, Android, Web, and Windows._
...
```dart
import 'package:canverro_gallery_task/l10n/l10n.dart';
...
{
    "@@locale": "en",
    "appTitle": "CANVERRO GALLERY TASK",
    "@appBarTitle": {
        "description": "Text shown in the AppBar of the Gallery"
    }
}
```
...
{
    "@@locale": "hi",
    "appTitle": "कैनवेरो गैलरी कार्य",
    "@appBarTitle": {
        "description": "गैलरी के ऐपबार में दिखाया गया टेक्स्ट"
    }
}
```
